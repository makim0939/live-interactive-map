...
import type { BoothInfo } from "./types.ts";
...
function App() {
	const [boothInViewport, setBoothInViewport] = useState<BoothInfo | undefined>(
		undefined,
	);
	useEffect(() => {
	...
	return (
		<>
			...
			{boothInViewport && (
				<BoothCard
					title={boothInViewport.title}
					description={boothInViewport.description}
				/>
			)}
		</>
	);
